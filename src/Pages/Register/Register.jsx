...
const Register = () => {
   ...
   return (
      <>
         ...
         <div className=" bg-gray-100 flex items-center justify-center mb-5 px-4 sm:px-6 lg:px-8">
            <div>
               <img src={image1} alt="" />
            </div>
            <div className="max-w-md w-full space-y-8">
               <form
                  className="border-2 border-gray-400 p-4 rounded-xl shadow-lg space-y-6"
